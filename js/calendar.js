(function(window) {
    ...
    var cal_days_labels = ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'],
        ...
        getDateText = function() {
            ...
            format = format.map(function(value) {
                return dateFunctionality[value]();
            });
            return format.join("-");
        },
    ...
    StnCalendar.prototype.init = function() {
    ...
    StnCalendar.prototype.show = function() {
        this.date = new Date(this.selectedDate);
        this.updateView();
        this.el.calendarPopup.style.display = "block";
    }
    StnCalendar.prototype.hide = function() {
        this.el.calendarPopup.style.display = "none";
    }
    StnCalendar.prototype.toggle = function() {
        if (this.el.calendarPopup.style.display == "none") {
            this.show();
        } else
            this.hide();
    }
    StnCalendar.prototype.today = function() {
        this.date = new Date();
        this.selectedDate = new Date();
        this.setDateVal();
        this.updateView();
    }
    StnCalendar.prototype.setDateVal = function() {
        this.selectedDate = new Date(this.date);
        this.el.dateContainer.textContainer.textContent = getDateText.apply(this);
        this.el.inputContainer.value = getDateText.apply(this);
    }
    StnCalendar.prototype.setDate = function(val) {
        this.date = new Date(val);
        this.selectedDate = new Date(val);
        this.setDateVal();
        this.updateView();
    }
    StnCalendar.prototype.updateView = function() {
        this.updateHeader();
        this.destroyDaysTable();
        this.createDaysView();
    }
    StnCalendar.prototype.toggleMonthView = function(e) {
        e.stopPropagation();
    ...
    StnCalendar.prototype.toggleYearView = function(e) {
        e.stopPropagation();
        this.updateYearView();
    ...
    StnCalendar.prototype.createMonthView = function() {
    ...
    StnCalendar.prototype.createYearView = function(direction) {
    ...
    StnCalendar.prototype.onMonthSelect = function(e) {
        e.stopPropagation();
    ...
    StnCalendar.prototype.onYearSelect = function(e) {
        e.stopPropagation();
    ...
    StnCalendar.prototype.setPrevYearList = function() {
    ...
    StnCalendar.prototype.setNextYearList = function() {
    ...
    StnCalendar.prototype.updateMonthView = function() {
    ...
    StnCalendar.prototype.updateYearView = function() {
        var currentYear = this.date.getFullYear();
        var startYear = currentYear - 4;
        for (var k = 0; k < 9; k++) {
            if ((startYear + k) === currentYear) {
    ...
    StnCalendar.prototype.createHeaderView = function() {
    ...
    StnCalendar.prototype.getMonthLength = function(month, year) {
    ...
    StnCalendar.prototype.createDaysView = function() {
    ...
    StnCalendar.prototype.getHTML = function() {
        return this.html;
    }
    StnCalendar.prototype.update = function() {
        this.name = "solomon";
        this.renderView();
    }
    StnCalendar.prototype.attachEvents = function() {
        var self = this;
    ...
    StnCalendar.prototype.onCalendarClick = function(event) {
    ...
    StnCalendar.prototype.updateHeader = function() {
    ...
    StnCalendar.prototype.prevMonth = function(e) {
        e.stopPropagation();
        var self = this;
    ...
    StnCalendar.prototype.nextMonth = function(e) {
        e.stopPropagation();
        var self = this;
    ...
    StnCalendar.prototype.prevYear = function(e) {
        e.stopPropagation();
    ...
    StnCalendar.prototype.nextYear = function(e) {
        e.stopPropagation();
        this.date.setFullYear(this.date.getFullYear() + 1);
        this.updateHeader();
        this.destroyDaysTable();
    ...
    StnCalendar.prototype.destroyDaysTable = function() {
        this.el.calendarPopup.removeChild(this.el.calendarPopup.daysTable);
    }

    StnCalendar.prototype.bodyClick = function(e) {
    ...
    window.StnCalendar = StnCalendar || {};
